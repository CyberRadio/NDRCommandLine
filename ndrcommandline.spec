...
Summary: CyberRadio Solutions, Inc., NDR-series Radio Console
Name: RPM_PKG_NAME
...
Requires: python3-cyberradiodriver
%else
Requires: python-cyberradiodriver
%endif
...
%description
Provides Console interface for NDR Radios
